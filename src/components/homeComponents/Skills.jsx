  ...
  return (
    <div className='skills- flex flex-wrap md:flex-nowrap bg-[#333] py-[8vh] md:py-[6vh] px-[2.8vw] md:px-[1.2vw] max-[528px]:gap-[2.5vh] gap-10 items-center justify-center'>
      {error ? (
        ...
        goals.length > 0 ? (
          goals.map(item => (
            <div className='rounded-lg  flex flex-col justify-center py-[2vw] md:py-[0.8vh] px-[2.8vw] md:px-[0.8vw] bg-white max-[350px]:w-[80%] max-[528px]:w-auto h-auto sm:w-[40vw]  md:w-[15vw] ' key={item._id}>
              ...
              <h1 className='heading2 my-2 text-[2vw]  max-[528px]:text-[3.5vw] md:text-[1.1vw]  font-["Montserrat"]'>{item.title}</h1>
              <p className='text-gray-500 text-[2vw] max-[528px]:text-[2.5vw] md:text-[0.8vw]'>{item.content}</p>
            </div>
          ))
        ) : (
