  ...
  return (
    <section className="w-full px-10 py-20 max-[599px]:py-10 flex items-center justify-between flex-col gap-4">
      ...
      <p className="text text-[1vw] max-[599px]:text-[3.3vw] font-[Poppins] w-[40%] max-[599px]:w-full text-center pb-8">
        We have a group of eminent Faculty members with great personality and
        excellence in their specific domains.
      </p>

      <div className="cards w-full flex items-center justify-between max-[599px]:flex-col gap-4 max-[599px]:hidden">
        ...
        <div className="card-2 h-full w-[25%] max-[599px]:w-full px-2 py-3 border-[1px] border-black rounded-xl">
          <div className="div w-full h-[35vh] rounded-xl bg-[#d9d9d9]"></div>
          <h1 className="py-2 text-[1.25vw] max-[599px]:text-[4.8vw] font-bold">
            Masters of Communication Application
          </h1>
        ...
        <div className="card-3 h-full w-[25%] max-[599px]:w-full px-2 py-3 border-[1px] border-black rounded-xl">
          <div className="div w-full h-[35vh] rounded-xl bg-[#d9d9d9]"></div>
          <h1 className="py-2 text-[1.25vw] max-[599px]:text-[4.8vw] font-bold">
            Masters of Communication Application
          </h1>
        ...
        <div className="card-4 h-full w-[25%] max-[599px]:w-full px-2 py-3 border-[1px] border-black rounded-xl">
          <div className="div w-full h-[35vh] rounded-xl bg-[#d9d9d9]"></div>
          <h1 className="py-2 text-[1.25vw] max-[599px]:text-[4.8vw] font-bold">
            Masters of Communication Application
          </h1>
