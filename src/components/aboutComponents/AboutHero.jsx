...
const AboutHero = () => {
  ...
  useEffect(() => {
    ...
    <div className="about_hero relative w-full h-[90vh] bg-gradient-to-b from-white via-gray-700 to-black">
      ...
      <div className="txt w-full h-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center gap-5 flex-col pt-10">
        <h1 className="w-1/2 text-center leading-tight text-[3.33vw] font-bold font-[Montserrat]">
          Let’s learn about new Knowledge and abitlites
        </h1>
        <p className="w-[58%] text-[1.25vw] font-medium text-center font-[Poppins]">
        ...
        <div className="btns flex items-center gap-4">
          <button className="bg-transparent text-[1vw] border-[1px] border-white px-3 py-2 rounded-md font-bold">Let's Started</button>
          <button className="bg-white text-[1vw] text-black px-4 py-2 rounded-md font-bold">Watch Now</button>
        </div>
      </div>
