...
useGSAP(() => {
  ...
  return (
    <div ref={loader} className='w-full h-screen bg-black text-white flex items-center justify-center z-[99999] cursor-none fixed top-0 left-0'>
      <div className="flex flex-col items-center gap-8">
        ...
        <div className="flex flex-col items-center gap-2 text-center">
          <h1 className="text-2xl max-[599px]:text-xl md:text-3xl font-bold font-[Montserrat] animate-pulse">Loading</h1>
          <p className="text-base max-[599px]:text-sm md:text-lg font-[Poppins] text-gray-400">Please wait while we prepare everything</p>
        </div>
      </div>
    </div>
  )
