...
const ContactUs = () => {
  ...
  return (
    <div className='Form_Container flex bg-[#d7d7d719] my-[2vh] max-[550px]:pt-[10%] px-[3vw] justify-between max-[823px]:flex-col items-center pt-[5vh] pb-[7vh]'>
      ...
      <div className='Container_Right bg-white rounded-3xl w-[38vw] max-[1179px]:w-[48vw] max-[822px]:w-[90vw] h-fit p-[2vw] max-[410px]:text-[4.5vw] max-[823px]:p-[4vw] text-[#333333] border-[1.1px] border-[#D7D7D7] shadow-lg shadow-gray-300 mt-[5vh] ml-[2vw]'>
        ...
        <form className='form flex flex-col gap-[1vh]' onSubmit={handleSubmit(onSubmit)}>
          ...
          <input
            type='email'
            {...register('cEmail')}
            className='border-b p-1 max-[410px]:text-[3vw] w-full border-[#A0A0A0] my-6 focus:outline-none text-[0.9vw] max-[830px]:text-[2.5vw]'
            placeholder='Email:'
          />
