...
const Login = () => {
  return (
    <section className='w-full h-screen flex items-center justify-center text-[#333] max-[999px]:flex-col'>
      <div className='left w-1/2 max-[999px]:w-full h-full max-[999px]:px-6 max-[999px]:pt-20 max-[999px]:pb-4 pt-36 px-20 flex flex-col items-start justify-center'>
        ...
        <input type="email" id="email" className='border border-gray-300 rounded-lg p-3 mb-4 w-full text-[0.8vw]' />
        <label htmlFor="password" className='text-[1vw] my-2 text-[#5F5F5F] max-[999px]:text-[3vw]' >Password</label>
        <input type="password" id="password" className='border border-gray-300 rounded-lg p-3 mb-4 w-full text-[0.8vw]' />
        ...
        <p className='text-[1.05vw] font-semibold mt-4 max-[999px]:text-[3.05vw]'>Registered?  <a href="#" className='text-[#FF6603]'> Create an Account</a></p>
        </div>
        </form>
      </div>
      <div className='right w-1/2 h-full max-[999px]:w-full'>
        <img
