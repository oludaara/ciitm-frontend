...
const Navbar = () => {
  ...
  return (
    <>
      <div ref={menu} className="mobile-menu w-full  h-screen bg-[#333] text-[6vw] font-semibold text-white hidden max-[599px]:block -translate-y-[100%] fixed top-0 left-0 z-[99]">
      ...
      <nav className="w-full fixed top-0 left-0 px-10 max-[599px]:px-6 py-3 z-[999] bg-white flex items-center justify-between">
        ...
        <div ref={open} className="bg-[#333] rounded-full text-white p-2 hidden max-[599px]:block">
          <IoMenu size={25} onClick={showMenu} />
        </div>
        <div ref={close} className="bg-[#333] rounded-full text-white p-2 hidden">
