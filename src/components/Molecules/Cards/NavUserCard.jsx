...
const UserProfileCard = ({
   ...
   containerClassName = 'p-[1vh] w-[25vw] h-[80%] bg-[#252323] rounded-lg flex items-center justify-center gap-[2vw] max-[1046px]:hidden',
   ...
   return (
      <div className={containerClassName}>
         ...
         <div className={textClassName}>
            <P2 text={actualUser?.email || 'user@email.com'} />
         </div>
         {showMenu && (
